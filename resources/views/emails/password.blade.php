                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h1>Hi!</h1>
                            <p class="lead">Your password has been reset</p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                  ...
                  <tr>
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td class="panel">
                            <p>Click here to <a href="{{ url('password/reset/'.$token) }}">continue »</a></p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td class="expander"></td>
                          <td align="center">
                            <p>If you did not request a password reset, or if you have
